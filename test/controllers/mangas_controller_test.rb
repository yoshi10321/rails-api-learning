...
class MangasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manga" do
    assert_difference('Manga.count') do
      post mangas_url, params: { manga: { img: @manga.img, number: @manga.number, title: @manga.title } }, as: :json
    end
  ...
  test "should update manga" do
    patch manga_url(@manga), params: { manga: { img: @manga.img, number: @manga.number, title: @manga.title } }, as: :json
    assert_response 200
  end
